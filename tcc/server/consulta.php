...
<html>
    <head>
        ...
        <link href="consulta.css" rel="stylesheet" type="text/css">
    </head>
    <body>
        <header>
       ...
       <div style="border: 1px solid brown">   </div>
        ...
        <section>
            ...
            <form method="post" action="consulta.php">
               ...
               <input type="radio" name="consulta" value="cliente"> 
                   <label> Cliente </label>       
                   </br>
               <input type="radio" name="consulta" value="técnico">   
                   <label>Técnico </label>
                                      </br>

               <input type="radio" name="consulta" value="os">     
                     <label>Ordem de serviço </label>    
                                        </br>

               <!--                ////////////      -->

               <input id="dado" type="text" nome="consulta">
